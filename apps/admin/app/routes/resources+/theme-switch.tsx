...
import { invariantResponse } from '@repo/utils'
import { data, redirect, useFetcher, useFetchers } from 'react-router'
import { ServerOnly } from 'remix-utils/server-only'
import { z } from 'zod'
import { Icon } from '~/components/ui/icon.tsx'
import { useHints, useOptionalHints } from '~/lib/client-hints.tsx'
import { useOptionalRequestInfo, useRequestInfo } from '~/lib/request-info.ts'
import { type Theme, setTheme } from '~/lib/theme.server.ts'
